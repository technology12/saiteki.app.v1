...
let requests = [
    ...
    {request:'かっこいいデザインにする', point:'機能性' },
    {request:'おもしろいデザインにする', point:'機能性' },
    {request:'オリジナリティのある形にする', point:'機能性' },
    {request:'よくある形にする', point:'機能性' },
    {request:'角張った形にする', point:'機能性' },
    {request:'丸みを帯びた形にする', point:'機能性' },
    {request:'大きい製作品にする', point:'機能性' },
    {request:'小さい製作品にする', point:'機能性' },
    {request:'正確な寸法にする', point:'機能性' },
    {request:'多少の寸法のずれは許容する', point:'生産効率' },
    {request:'きれいな木目を生かせる材料を主に使う（製材品）', point:'機能性' },
    {request:'強度や品質が安定した材料を主に使う（集成材）', point:'生産効率' },
    {request:'厚い材料にする', point:'安全性' },
    {request:'薄い材料にする', point:'生産効率' },
    {request:'複数の材料を使用する', point:'機能性' },
    {request:'１種類の材料を使用する', point:'生産効率' },
    {request:'加工しやすい材料を使用する', point:'生産効率' },
    {request:'加工が難しい材料を使用する', point:'機能性' },
    ...
    {request:'三角形の構造を取り入れる', point:'安全性' },
    {request:'面構造を取り入れる', point:'安全性' },
    {request:'接合部を金具などで固定する', point:'安全性' },
    {request:'部材の断面形状を工夫する', point:'安全性' },
    {request:'部材の断面積を増やす', point:'安全性' },
